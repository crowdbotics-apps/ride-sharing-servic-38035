...
## Project Structure
    ...
    ├── ride_sharing_servic_38035  # Django project configurations
...
1. Clone this repo and `cd ride_sharing_servic_38035`
...
2. Clone this repo and `cd ride_sharing_servic_38035`
